function [P1val,P2val,P3val,betauval,betawval]=LMI_Aut17_th1(D0,beta,A,B,K,muT,muB,Neum,l,nu,epsilon,alpha,h)
...
%% Solution of LMIs
LMIs=[Phi<=0,W>=0,betau>=0,betaw>=0,P1>=0,P3>=0,Lambdaf>=0,Lambdakappa>=0,LambdaD>=0]; 
